    ...
    class Program
    {
        private static Afstand afstand = null!;
        private static Tilt tilt = null!;
        private static Kapacitiv kapacitiv = null!;

        private static HomeAssistant haController = null!;

        private static bool systemOn = false;
        private static bool tiltActive = false;
        private static double tiltAngleThreshold = 30.0;
        private static LEDController? LedController = null!;
        ...
        private static void CheckForTilt()
        {
            ...
            if (angle.HasValue && angle.Value > tiltAngleThreshold && !tiltActive)
            {
